...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_apiurl_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/apiurl.js */ \"./src/modules/apiurl.js\");\n// console.log('hola');\n\n\n\nconst btnRefresh = document.getElementById('refresh');\n\nconst updateScores = async () => {\n  const scrDispl = document.getElementById('scores');\n\n  while (scrDispl.firstChild) {\n    scrDispl.removeChild(scrDispl.firstChild);\n  }\n\n  const usersData = await (0,_modules_apiurl_js__WEBPACK_IMPORTED_MODULE_1__.getUser)();\n\n  usersData.result.forEach((entry) => scrDispl.insertAdjacentHTML('beforeend', `\n    <td>${entry.user}: ${entry.score}</td>  \n  `));\n};\n\nbtnRefresh.addEventListener('click', updateScores);\n\nconst userSub = document.getElementById('btn-newbook');\n\nuserSub.addEventListener('click', async (e) => {\n  e.preventDefault();\n  let name = document.getElementById('recibe-nom').value;\n  let score = document.getElementById('recibe-age').value;\n\n  if (name !== '' && score !== '') {\n    const data = {\n      user: name,\n      score,\n    };\n\n    await (0,_modules_apiurl_js__WEBPACK_IMPORTED_MODULE_1__.newUser)(data);\n\n    name = '';\n    score = '';\n  }\n  updateScores();\n});\n\ndocument.addEventListener('DOMContentLoaded', () => {\n  (0,_modules_apiurl_js__WEBPACK_IMPORTED_MODULE_1__.game)(`created at: ${new Date()}`);\n  updateScores();\n});\n\n//# sourceURL=webpack://leaderboard/./src/index.js?");
